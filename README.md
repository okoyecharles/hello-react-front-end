...
#### Github
- Enter this url: [https://github.com/OkoyeCharles/hello-react-front-end/](https://github.com/OkoyeCharles/hello-react-front-end/) in your web browser.
...
```sh
  git clone github.com/OkoyeCharles/hello-react-front-end/.git
